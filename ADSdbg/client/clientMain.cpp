...
class CclientCtrl : public ITcOCFCtrlImpl<CclientCtrl, CclientClassFactory>
{
public:
	CclientCtrl() {};
	virtual ~CclientCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("client: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CclientCtrl>;
